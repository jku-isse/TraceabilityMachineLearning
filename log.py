...
def main(seed):
   ...
   # split data into train and test sets
    ...
    i=0
    f = open("log.txt", "a")
    f.write("ProgramName,MethodType,RequirementID,MethodID,MethodType,CallersT,CallersN,CallersU,CallersCallersT,CallersCallersN,CallersCallersU,CalleesT,CalleesN,CalleesU,CalleesCalleesT,CalleesCalleesN,CalleesCalleesU,pred,gold\n")
    while i < y_pred.size:
